...
func DeserializeUser(c *fiber.Ctx) error {
	...
	err = initializers.DB.Preload("Followings").Preload("Followers").Preload("Profile.City").Preload("Profile.Guilds").Preload("Profile.Hashtags").Preload("Profile.Photos").First(&user, "id = ?", tokenClaims.UserID).Error
